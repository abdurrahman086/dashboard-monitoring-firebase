...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({ onShowJsonGuide }) => {
  ...
  return (
    <header className="h-14 bg-card border-b border-border flex items-center justify-between px-6 shrink-0">
      <div>
        <span className="text-sm text-muted-foreground">IDN Boarding School Sentul</span>
        <h1 className="text-xl font-bold text-foreground -mt-1">RTDB Dashboard Firebase</h1>
      </div>
